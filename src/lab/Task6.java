...
public class Task6 {
    /**
     * TASk 2, TASK 3, and TASK 4, and TASK 5, and Task 6 IMPLEMENTATION.
     * Some of task2, task3, and task4, task5 parts may have been changed when writing task6
     **/
                    ...
                    if (movies.length == 0) {
                        ...
                        if (foundMovieIndex != -1) {
                            System.out.printf("""
                                    ...
                                    The movie you searched for has a rating of:
                                    %.1f
                ...
                case 6: {
                    ...
                    if (movies.length == 0) {
                        System.out.println("""
                                ...
                                Unfortunately there are no movies to update :(""");
                        break;
                    } else {
                        System.out.println("""
