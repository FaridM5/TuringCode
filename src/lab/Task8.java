...
public class Task8 {
    /**
     * TASk 2, TASK 3, and TASK 4, and TASK 5, and Task 6, Task 7, Task 8 IMPLEMENTATION.
     * Some of task2, task3, and task4, task5, task6, task 7 parts may have been changed when writing task7
     **/
    ...
    static void sortArray(Movie[] movies) {
            ...
            switch (userInput) {
                ...
                case 8: {
                    System.out.println("""
                            ...
                            You selected to sort the a movie!""");
                    if (movies.length == 0) {
                        System.out.println("""
                                
                                Unfortunately there is no movie to sort :(""");
                        break;
                    } else if (!(movies.length == 1)) {
                        sortArray(movies);
                    }
